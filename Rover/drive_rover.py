...
class RoverState():
    def __init__(self):
        ...
        #self.rock_angles = None # Angles of navigable rock pixels
        #self.rock_dists = None # Distances of navigable rock pixels
        ...
        self.ground = 0 # Sum of the pixels representing ground
        #self.rock = 0 # Sum of the pixels representing rocks
        #self.pos_visit = set() # Keep track of position in the world visited
